...
public class DataSeeder {
    ...
    private static final String SEEDED_NAME = "Seeded Guest";
    private static final String SEEDED_EMAIL = "seeded.guest@example.com";
    private static final String SEEDED_PHONE = "+372 5000000";
    private static final String SEEDED_ADDITIONAL_INFO = "This reservation was generated by the data seeder.";
